...
export const gameData = {
  ...
  socialCards: [
    {
      ...
      subcategories: [
        ...
        { name: "First Thought", instruction: "The player on your right says any word. Immediately say the first word that comes to mind from it. If you hesitate or freeze, drink 2." },
  ...
  crowdChallenge: {
    ...
    subcategories: [
      ...
      { name: "Lowest Fingers", instruction: "Behind your back, choose 0-5 fingers. Reveal at the same time. The player(s) showing the lowest number drink 1. Any player who matched someone else's number also drinks 1." },
      ...
      { name: "Two Truths and a Lie", instruction: "Say two truths and one lie. Everyone guesses which one is the lie. Anyone who guesses correctly gives 1." },
      ...
      { name: "One's Gotta Go", instruction: "Name 3 things in one category. Everyone holds up 1, 2, or 3 to vote for the worst one. Minority voters drink 1." },
      { name: "Bet the Number", instruction: "Ask a question with a numeric answer. Everyone gets one guess. The closest guess without going over gives 3. Any guess over the answer drinks 1. If every guess goes over, everyone drinks 1." },
  ...
  special: {
    ...
    subcategories: [
      ...
      { name: "Oldest Drinks", instruction: "The oldest player drinks one." },
      {
        ...
        instruction: "Player(s) with the fewest drinks taken so far drink 1.",
        leaderboardTopic: "drinks_taken_min"
      },
      {
        name: "Party Sponsor",
        instruction: "Player(s) with the most drinks taken so far give 3.",
        leaderboardTopic: "drinks_taken_max"
      },
