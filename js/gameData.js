  ...
  socialCards: [
    {
      ...
      subcategories: [
        ...
        { name: "Cringe Archive", instruction: "Tell one cringe moment. If you refuse, take a Penalty card." },
        ...
        { name: "Room Alias", instruction: "Describe an object in the room without saying its name. The first correct guess may give out 2 drinks." },
        { name: "Instant Opinion", instruction: "Name a topic. Everyone must immediately give a one-word opinion. Anyone who stays silent drinks 3." },
        { name: "Unnecessary Skill", instruction: "Share one useless skill you have. If anyone claims it is actually useful, you drink 1." },
        { name: "One's Gotta Go", instruction: "Name 4 things in the same category (for example, 4 foods). Everyone points to the one that does not belong. Count the votes. Players who voted for the least popular choice (the minority) drink 1." },
        ...
        { name: "Bet the Number", instruction: "Ask a question with a numeric answer. Everyone gives one guess. Reveal the real answer. The winner is the highest guess that is not over the real answer. The winner gives 3 drinks. Anyone who guessed over the real answer drinks 1. If everyone guessed over, everyone drinks 1." },
